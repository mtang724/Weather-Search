...
let CurrentTabComponent = class CurrentTabComponent {
    constructor(http) {
        this.http = http;
...
CurrentTabComponent.ctorParameters = () => [
...
let HourlyTabComponent = class HourlyTabComponent {
    constructor() {
...
let TabsetsComponent = class TabsetsComponent {
    constructor(config) {
...
TabsetsComponent.ctorParameters = () => [
...
let WeeklyTabComponent = class WeeklyTabComponent {
    ...
    ngAfterViewInit() {
        ...
        let chart = new _assets_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_2__["Chart"]("chartContainer", {
...
WeeklyTabComponent.ctorParameters = () => [
